...
public:
    ...
    ReaderWriterJSON()
    {
        ...
        supportsOption("useSpecificBuffer=uservalue1[:buffername1],uservalue2[:buffername2]","uses specific buffers for unshared buffers attached to geometries having a specified user value. Buffer name *may* be specificed after ':' and will be set to uservalue by default.");
